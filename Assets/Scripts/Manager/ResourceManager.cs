...
public class ResourceManager
{
    ...
    public GameObject Instantiate_Timer(string path, float time, Transform parent = null)
    {
        GameObject go = Instantiate(path, parent);
        Managers.Instance.StartCoroutine(Destroy_Timer(go, time));
    ...
    IEnumerator Destroy_Timer(GameObject go, float timer)
    {
